...
Comment=%{bookname} Tome 1 Le Premier Monde - � la recherche d'un Dieu
...
Comment=%{bookname} Tome 4 Le Premier Monde - M�nocha
...
[Desktop Entry]
Name=%{bookname} Tome 4 postscript
Comment=%{bookname} Tome 4 The First World - M�nocha
Exec=xdg-open %{_datadir}/%name/A4-patriarche-1.4.ps
Icon=documentation_section
Terminal=false
Type=Application
